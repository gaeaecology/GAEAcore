...
/*
There are 3 ways to customize conf in modules that use GAEAcore lib:
...
if (exports.storage === 'mysql'){
	...
	exports.database.name = exports.database.name || 'GAEA';
	exports.database.user = exports.database.user || 'GAEA';
}
else if (exports.storage === 'sqlite'){
	exports.database.max_connections = exports.database.max_connections || 1;
	exports.database.filename = exports.database.filename || (exports.bLight ? 'GAEA-light.sqlite' : 'GAEA.sqlite');
}
